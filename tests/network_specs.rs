...
mod network_spec {
    ...
    fn new_network() {
        ...
        Network::from_config(cuda_backend(), &cfg);
    }
    ...
    fn mnist_forward_backward() {
        ...
        //     axis: None
        // };
        // let mut conv_cfg = LayerConfig::new("conv", LayerType::Convolution(conv_layer_cfg));
        // conv_cfg.add_input("in");
        // conv_cfg.add_output("conv_out");
        // cfg.add_layer(conv_cfg);
        ...
        let mut fc_layer_cfg = LinearConfig {
            output_size: 10,
        };
    ...
    fn small_alexnet_forward() {
        ...
        // Layer: fc1
        let mut fc1_layer_cfg = LinearConfig {
            output_size: 2048,
        };
        ...
        // Layer: fc2
        let mut fc2_layer_cfg = LinearConfig {
            output_size: 2048,
        };
        ...
        // Layer: fc3
        let mut fc3_layer_cfg = LinearConfig {
            output_size: 500,
        };
